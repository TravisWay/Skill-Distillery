...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-0" data-genuitec-path="/ShoppingCart/WebContent/WEB-INF/cart.jsp">
	
	<form action="addItem.do" method="POST" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-0" data-genuitec-path="/ShoppingCart/WebContent/WEB-INF/cart.jsp">
