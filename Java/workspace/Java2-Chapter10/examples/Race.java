...
public class Race implements Callable<String> {
	...
	public static void main(String[] args) throws Exception {
		...
		// List<String> races = Collections.synchronizedList (theList);

		ExecutorService ex = Executors.newCachedThreadPool();
	    Future<String> listAResult = ex.submit(new Race());
	    Future<String> listBResult = ex.submit(new Race());
	    Future<String> listCResult = ex.submit(new Race());
