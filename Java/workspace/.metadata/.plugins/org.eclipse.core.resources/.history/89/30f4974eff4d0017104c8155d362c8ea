...
The jet objects are all added to a object array and finding either the fastest or the plane with the longest range involves searching that array.  Adding a plane takes in the necessary parameters and adds it to the object array so that they may be seen and searchable as well.